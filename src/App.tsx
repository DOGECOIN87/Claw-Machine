...
export default function App() {
  ...
  return (
    <div className="w-full h-screen bg-[#020510] relative overflow-hidden font-sans">
      <Canvas shadows camera={{ position: [0, 10, 26], fov: 40, near: 0.1, far: 100 }}>
        ...
        <pointLight position={[0, 8, 15]} intensity={8} color="#34EDF3" distance={20} />

        <OrbitControls target={[0, 4, 3]} enablePan={false} enableZoom={false} enableRotate={false} />
